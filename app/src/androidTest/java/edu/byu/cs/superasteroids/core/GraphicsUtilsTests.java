...
public class GraphicsUtilsTests extends AndroidTestCase {
    ...
    public void testRadiansToDegrees() {
        assertEquals(90.0, radiansToDegrees(ZERO));
        assertEquals(180.0, radiansToDegrees(HALF_PI));
        assertEquals(270.0, radiansToDegrees(PI));
        assertEquals(360.0, radiansToDegrees(THREE_HALF_PI));
        assertEquals(450.0, radiansToDegrees(TWO_PI));
    }
